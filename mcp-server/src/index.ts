...
const { portfolioData } = require("../../data/portfolio-data.js") as any;
...
const searchProjects = (query: string) => {
    ...
    return portfolioData.projects.filter(
        (p: any) =>
            ...
            p.technologies.some((t: any) => t.toLowerCase().includes(lowerQuery))
    );
};
    ...
    return {
        tools: [
            ...
            },
            {
                ...
                description:
                    "Returns a SUMMARY list of all projects. Does NOT include full details. Use get_project_details for deep dives.",
                inputSchema: {
                    type: "object",
                    properties: {},
                },
            ...
            },
            {
                ...
                description:
                    "Returns skills grouped by category (frontend, backend, tools, etc.)",
                inputSchema: {
                    type: "object",
                    properties: {},
                },
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    switch (name) {
        case "search_projects": {
            ...
            const results = searchProjects(query).map((p: any) => ({
                name: p.name,
        ...
        case "get_all_projects": {
            const projectsSummary = portfolioData.projects.map((p: any) => ({
                name: p.name,
                description: p.description,
                technologies: p.technologies,
                githubUrl: p.githubUrl,
        ...
        case "get_project_details": {
            ...
            if (!project) {
                project = portfolioData.projects.find(
